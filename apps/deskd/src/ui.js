...
.top .who{margin-left:auto}.topback{display:inline-flex;align-items:center;gap:6px;white-space:nowrap}.topback svg{width:16px;height:16px}.top .brand{display:flex;align-items:center;gap:8px;color:var(--ink);text-decoration:none;font-weight:600;letter-spacing:-.01em}.top .brand .mark{width:26px;height:27px;color:var(--blue);flex:none}.top .brand .wm{white-space:nowrap}.top .brand .wm em{font-style:normal;font-family:Fraunces,Georgia,serif;font-weight:600;font-size:1.1em;color:var(--blue-deep);margin-left:.22em}
...
export function layout({ title, business, body, back = '/', backLabel = 'Back to Desk', head = '' }) {
  return `<!doctype html><html lang="en"><meta charset="utf-8"><meta name="viewport" content="width=device-width,initial-scale=1"><title>${esc(title)} · webfaCe Desk</title><script>/* A download is a scripted <a download> click — what the Session log export does; the desktop app saves it with a native panel. */function deskDownload(u,name){var a=document.createElement('a');a.href=new URL(u,location.href).href;a.download=name||u.split('/').pop().split('?')[0];a.style.display='none';document.body.appendChild(a);a.click();setTimeout(function(){a.remove()},1000);return false}</script><script src="https://insights.webfacemedia.com/api/script.js" data-site="webface" defer></script>
...
<body><div class="top"><a class="brand" href="/">${MARK}<span class="wm">webfaCe<em>Desk</em></span></a><span class="who">${esc(business)}</span><a class="btn ghost topback" href="/" style="margin:0;padding:6px 12px;font-size:13px">${ICONS.back} Desk</a></div><main>${body}</main></body></html>`
}
