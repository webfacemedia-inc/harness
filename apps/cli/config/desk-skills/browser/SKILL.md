...
## Hard rules
- **Never type a password, one-time code, or card number.** When a page needs a login, 2FA or a CAPTCHA, stop and ask the owner to take the mouse: say which site and which step, wait, then continue once they confirm.
