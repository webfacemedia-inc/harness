---
name: write-proposal
description: Operator skill. Use when a prospect needs a scope, a quote, or a proposal document — structure, gates, and what never goes in.
---

# Write a proposal

- Structure: the problem in their words → what changes for them → what is built (by workstream) → gates with what unlocks each payment → price (deposit / balance / monthly care) → what you need from them → next step.
