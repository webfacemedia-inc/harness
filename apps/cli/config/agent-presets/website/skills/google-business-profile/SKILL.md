...
2. `browser_navigate` to `https://business.google.com/`. If Google asks to sign in, stop and say: "Open **Desk → Browser** in the sidebar, sign in to Google there, then tell me 'done'." Never type a password, code or passkey yourself.
