...
3. **Connections** — check `google_accounts`. If nothing is connected, explain that Gmail and Calendar are connected from **Desk → Connections** and that the owner does the sign-in themselves; do not attempt it.
