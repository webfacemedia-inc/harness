...
export const en = {
  ...
  'placeholder.unavailable': 'This conversation is unavailable',
  'placeholder.parentOffline': 'The parent conversation is offline; you can still stop this run',
  'placeholder.hero': 'Ask Desk anything',
  ...
  'image.subagentUnsupported': 'Helper conversations do not take images yet',
  ...
  'access.confirm.description': 'Full access means Desk stops asking before each step and can change files, run commands and use connected tools directly. Turn it on only for work you trust it with.',
  ...
  'hero.headline': 'What should Desk take on?',
  'hero.preview': '',
  'hero.chooseWorkspace': 'Choose folder',
  ...
  'message.contextRecall': 'Recalled from earlier work',
  ...
  'message.context.relay.from': 'From conversation {session}',
  ...
  'queue.steer.unavailable': 'You can only redirect Desk while it is working',
